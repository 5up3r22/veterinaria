...
<body>
  ...
  <script>
    ...
    function validarFormularioMascota() {
      ...
      const alerta = document.getElementById('alerta');
      if (name === '' || petBreed === '' || gender === '-1' || owner === '-1') {
        alerta2.innerHTML = 'Please check the fields and select an option.';
        alerta2.style.display = 'block';
        return false;
      } else {
  ...
  <script>
    function validarFormularioMascota2() {
        const name2 = document.getElementById('newName').value;
      const petBreed2 = document.getElementById('newPetBreed').value;
      const gender2= document.getElementById('newGender').value;
      const owner2= document.getElementById('newOwner').value;
      const alerta2 = document.getElementById('alerta2');
      if (name2 === '' || petBreed2 === '' || gender2 === '-1' || owner2 === '-1') {
        alerta2.innerHTML = 'Please check the fields and select an option.';
        alerta2.style.display = 'block';
        return false;
      } else {
